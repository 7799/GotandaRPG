package com.gpl.rpg.GotandaRPG.resource;
...
import com.gpl.rpg.GotandaRPG.conversation.ConversationCollection;
import com.gpl.rpg.GotandaRPG.model.map.TMXMapTranslator;
import com.gpl.rpg.GotandaRPG.resource.parsers.*;
...
public final class ResourceLoader {
	...
	private static final int itemsResourceId = GotandaRPGApplication.DEVELOPMENT_DEBUGRESOURCES ? R.array.loadresource_items_debug : R.array.loadresource_items;
	private static final int droplistsResourceId = GotandaRPGApplication.DEVELOPMENT_DEBUGRESOURCES ? R.array.loadresource_droplists_debug : R.array.loadresource_droplists;
	private static final int questsResourceId = GotandaRPGApplication.DEVELOPMENT_DEBUGRESOURCES ? R.array.loadresource_quests_debug : R.array.loadresource_quests;
	private static final int conversationsListsResourceId = GotandaRPGApplication.DEVELOPMENT_DEBUGRESOURCES ? R.array.loadresource_conversationlists_debug : R.array.loadresource_conversationlists;
	private static final int monstersResourceId = GotandaRPGApplication.DEVELOPMENT_DEBUGRESOURCES ? R.array.loadresource_monsters_debug : R.array.loadresource_monsters;
	private static final int mapsResourceId = GotandaRPGApplication.DEVELOPMENT_DEBUGRESOURCES ? R.array.loadresource_maps_debug : R.array.loadresource_maps;
	...
	public static void loadResources(WorldContext world, Resources r) {
		...
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("prepareTilesets");
		...
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("VisualEffectLoader");

		// ========================================================================
		// Load skills
		world.skills.initialize();
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("SkillLoader");
		...
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("ItemCategoryParser");
		...
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("ActorConditionsTypeParser");
		...
		itemsToLoad.recycle();
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("ItemTypeParser");
		...
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("DropListParser");
		...
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("QuestParser");
		...
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("ConversationListParser");
		...
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("MonsterTypeParser");
		...
		mapsToLoad.recycle();
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("TMXMapReader");
		world.maps.addAll(mapReader.transformMaps(world.monsterTypes, world.dropLists));
		loader.prepareAllMapTiles();
		mapReader = null;
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("mapReader.transformMaps");
		...
		loader.flush();
		loader = null;
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("DynamicTileLoader");
		// ========================================================================
		...
		if (GotandaRPGApplication.DEVELOPMENT_DEBUGMESSAGES) timingCheckpoint("WorldMapParser");
		// ========================================================================
