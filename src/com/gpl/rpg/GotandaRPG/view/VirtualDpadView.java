...
public final class VirtualDpadView extends ImageView implements OnClickListener {
	...
	public void updateVisibility(GotandaRPGPreferences preferences) {
		int dpadPosition = preferences.dpadPosition;
		if (dpadPosition == GotandaRPGPreferences.DPAD_POSITION_DISABLED) {
		...
		switch (dpadPosition) {
			case GotandaRPGPreferences.DPAD_POSITION_LOWER_RIGHT:
				...
				break;
			case GotandaRPGPreferences.DPAD_POSITION_LOWER_LEFT:
				params.addRule(RelativeLayout.ALIGN_LEFT, R.id.main_mainview);
				params.addRule(RelativeLayout.ALIGN_BOTTOM, R.id.main_mainview);
				break;
			case GotandaRPGPreferences.DPAD_POSITION_LOWER_CENTER:
				params.addRule(RelativeLayout.CENTER_HORIZONTAL);
				params.addRule(RelativeLayout.ALIGN_BOTTOM, R.id.main_mainview);
				break;
			case GotandaRPGPreferences.DPAD_POSITION_UPPER_RIGHT:
				params.addRule(RelativeLayout.ALIGN_RIGHT, R.id.main_mainview);
				params.addRule(RelativeLayout.ALIGN_TOP, R.id.main_mainview);
				break;
			case GotandaRPGPreferences.DPAD_POSITION_UPPER_LEFT:
				params.addRule(RelativeLayout.ALIGN_LEFT, R.id.main_mainview);
				params.addRule(RelativeLayout.ALIGN_TOP, R.id.main_mainview);
				break;
			case GotandaRPGPreferences.DPAD_POSITION_UPPER_CENTER:
				params.addRule(RelativeLayout.CENTER_HORIZONTAL);
				params.addRule(RelativeLayout.ALIGN_TOP, R.id.main_mainview);
				break;
			case GotandaRPGPreferences.DPAD_POSITION_CENTER_LEFT:
				params.addRule(RelativeLayout.ALIGN_LEFT, R.id.main_mainview);
				params.addRule(RelativeLayout.CENTER_VERTICAL);
				break;
			case GotandaRPGPreferences.DPAD_POSITION_CENTER_RIGHT:
				params.addRule(RelativeLayout.ALIGN_RIGHT, R.id.main_mainview);
				params.addRule(RelativeLayout.CENTER_VERTICAL);
				break;
		}
