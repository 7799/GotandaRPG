...
import com.gpl.rpg.GotandaRPG.controller.listeners.QuickSlotListeners;
...
import com.gpl.rpg.GotandaRPG.model.item.*;
...
public final class ItemController {
	...
	private boolean pickupLootBagWithoutConfirmation(Loot bag) {
		...
		switch (controllers.preferences.displayLoot) {
			case GotandaRPGPreferences.DISPLAYLOOT_DIALOG_ALWAYS:
				return false;
			case GotandaRPGPreferences.DISPLAYLOOT_DIALOG_FOR_ITEMS:
	...
	private boolean pickupLootBagsWithoutConfirmation(Collection<Loot> bags) {
		if (controllers.preferences.displayLoot == GotandaRPGPreferences.DISPLAYLOOT_DIALOG_ALWAYS) return false;
		for (Loot bag : bags) {
