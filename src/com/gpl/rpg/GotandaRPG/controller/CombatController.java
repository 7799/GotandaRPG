...
import com.gpl.rpg.GotandaRPG.controller.VisualEffectController.VisualEffectCompletedCallback;
import com.gpl.rpg.GotandaRPG.controller.listeners.CombatActionListeners;
import com.gpl.rpg.GotandaRPG.controller.listeners.CombatSelectionListeners;
import com.gpl.rpg.GotandaRPG.controller.listeners.CombatTurnListeners;
...
import com.gpl.rpg.GotandaRPG.model.item.ItemTraits_OnUse;
...
public final class CombatController implements VisualEffectCompletedCallback {
	...
	private void executeFlee(int dx, int dy) {
		...
		if (!controllers.movementController.findWalkablePosition(dx, dy, GotandaRPGPreferences.MOVEMENTAGGRESSIVENESS_DEFENSIVE)) return;
