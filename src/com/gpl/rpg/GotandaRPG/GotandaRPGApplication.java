...
public final class GotandaRPGApplication extends Application {
	...
	private final GotandaRPGPreferences preferences = new GotandaRPGPreferences();
	...
	public GotandaRPGPreferences getPreferences() { return preferences; }
	public ControllerContext getControllerContext() { return controllers; }

	public static GotandaRPGApplication getApplicationFromActivity(Activity activity) {
		return ((GotandaRPGApplication) activity.getApplication());
	}
	public static GotandaRPGApplication getApplicationFromActivityContext(Context context) {
