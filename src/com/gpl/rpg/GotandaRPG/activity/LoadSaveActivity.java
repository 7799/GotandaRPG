...
public final class LoadSaveActivity extends Activity implements OnClickListener {
	...
	private GotandaRPGPreferences preferences;
	...
	private String getConfirmOverwriteQuestion(int slot) {
		...
		if (preferences.displayOverwriteSavegame == GotandaRPGPreferences.CONFIRM_OVERWRITE_SAVEGAME_ALWAYS) {
			return getString(R.string.loadsave_save_overwrite_confirmation_all);
		}
		if (preferences.displayOverwriteSavegame == GotandaRPGPreferences.CONFIRM_OVERWRITE_SAVEGAME_NEVER) {
			return null;
		}
